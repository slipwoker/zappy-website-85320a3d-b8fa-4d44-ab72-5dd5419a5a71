document.addEventListener('DOMContentLoaded', function () {
  ...
  function initScrollAnimations() {
    if (!('IntersectionObserver' in window)) {
      const allTargets = document.querySelectorAll(animationSelectors);
    ...
    const targets = document.querySelectorAll(animationSelectors);
    ...
    targets.forEach(function (el, index) {
      ...
      if (!el.hasAttribute('data-delay') && !el.dataset.animateDelay) {
        ...
        const staggerDelay = siblingIndex > 0 ? Math.min(siblingIndex * 100, 400) : 0;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '85320a3d-b8fa-4d44-ab72-5dd5419a5a71',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '85320a3d-b8fa-4d44-ab72-5dd5419a5a71';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '85320a3d-b8fa-4d44-ab72-5dd5419a5a71';
